...
@Component({
  selector: 'app-payment-later-last-month',
  templateUrl: './payment-later-last-month.component.html',
  styleUrl: './payment-later-last-month.component.scss'
})
export class PaymentLaterLastMonthComponent {
  ...
  ngOnInit(): void {
    // this.getLaterLastMonth(thiemployeeId);
    this.getCurrency();
}
constructor(
  ...
  this.salaryservice
    ...
    .subscribe({
      next: (resp: any) => {
        ...
        this.dataRowSource = this.LaterLastMonthSalary.httpResponse;
        console.log("Later Last Month",this.dataRowSource);
